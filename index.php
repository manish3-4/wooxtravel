...
countries.image AS image,countries.continent AS continent,countries.population AS population,countries.territory
 AS territory,countries.description AS description,AVG(cities.price) AS avg_price FROM countries JOIN 
      ...
      <div class="row">
        <div class="col-lg-5">
          <div class="section-heading">
            <h2 style="color:cyan;">Visit One Of Our Countries Now</h2>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-8 col-sm-7">
                      <div class="right-content">
                        <h4 style="color:aqua"><?php echo $country->name ;?></h4>
