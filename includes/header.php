<?php
    session_start();//sessions are the way to  carry information acrross multiple pages
            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav">
                        ...
                        <?php if(isset($_SESSION['username'])) : ?>  <!--when we are logged in to remove login nd register button-->
                         <!-- ***** user Menu ***** -->
                      ...
                      <?php else : ?><!--when we are logged in to remove login nd register button-->
                        <li><a href="<?php echo APPURL; ?>/auth/login.php">Login</a></li>
                        <li><a href="<?php echo APPURL;?>/auth/register.php">Register</a></li>
                        <?php endif; ?><!--when we are logged in to remove login nd register button-->
                    </ul>   
